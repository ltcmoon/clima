document.querySelector('.busca').addEventListener('submit', async (event) => {
    ...
    if(input !== '') {
        ...
        let results = await fetch(`https://api.openweathermap.org/data/2.5/we
            ather?q=
            ${encodeURI(input)}&units=metric&lang=pt_br&appid=d06cdb298fafc
            83c520d5ab677fc477e`);
            ...
            function showInfo(obj) {
                ...
                document.querySelector('.tempInfo').innerHTML = `${obj.temp} <sup>º C/sup>`;
